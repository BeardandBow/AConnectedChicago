class Admin::SubmissionsController < ApplicationController
  ...
  def get_unowned_submissions
    ...
    art_without_org_users = Artwork.joins(:organization).find_all { |s| s.organization.users = [] }
    art_without_hood_users = Artwork.joins(:neighborhood).find_all { |s| s.neighborhood.users = [] }
    ...
    stories_without_org_users = Story.joins(:organization).find_all { |s| s.organization.users = [] }
    stories_without_hood_users = Story.joins(:neighborhood).find_all { |s| s.neighborhood.users = [] }
